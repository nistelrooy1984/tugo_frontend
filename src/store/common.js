...
export const common = {
  ...
  mutations: {
    ...
    set_countries_provinces_districts_data(
      state,
      countries_provinces_districts
    ) {
      state.masters_data.master_countries =
        countries_provinces_districts.master_countries;
      state.masters_data.master_provinces =
        countries_provinces_districts.master_provinces;
      state.masters_data.master_districts =
        countries_provinces_districts.master_districts;
    },
